...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            var messages = await _context.Messages.Where(m => (m.RecipientId == userId && m.SenderId == recipientId && m.RecipientDeleted == false) || (m.RecipientId == recipientId && m.SenderId == userId && m.SenderDeleted == false))
